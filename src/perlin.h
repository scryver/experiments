...
perlin_noise(PerlinNoise *perlin, f32 p)
{
    ...
    u32 i = perlin->permutations[b0];
    u32 j = perlin->permutations[b0 + 1];
    u32 ii = perlin->permutations[i & PERLIN_DEPTH_MASK];
    u32 ji = perlin->permutations[j & PERLIN_DEPTH_MASK];
    
    f32 u, v;
    
    u = gradient(perlin->permutations[ii & PERLIN_DEPTH_MASK], r0, r1, 0);
    v = gradient(perlin->permutations[ji & PERLIN_DEPTH_MASK], r1, r0, 0);
