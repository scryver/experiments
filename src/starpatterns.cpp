...
DRAW_IMAGE(draw_image)
{
    ...
    if (!state->initialized)
    {
        ...
        starState->poly.points = allocate_array(v2, starState->poly.sides);
        starState->poly.edges = allocate_array(Edge, starState->poly.sides);
    ...
    starState->prevMouseDown = mouse.mouseDowns;
