...
internal String
print_fft_recurse(Arena *memory, ApiFile *file, u32 dftCount, u32 signalIndex = 0, u32 dftIndex = 0, u32 step = 1)
{
    String result = {};
    result.data = arena_allocate_array(memory, u8, 10);
...
internal String
print_fft_recurse2(Arena *memory, ApiFile *file, u32 dftCount, u32 signalIndex = 0, u32 dftIndex = 0, u32 step = 1)
{
    String result = {};
    result.data = arena_allocate_array(memory, u8, 10);
    result = string_fmt(9, result.data, "d%u_%u", dftCount, signalIndex);
...
internal void
print_iter2(Arena *memory, ApiFile *file, u32 dftCount)
{
    u32 baseDftCount = 16;
