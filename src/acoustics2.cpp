...
DRAW_IMAGE(draw_image)
{
    ...
    if (!state->initialized)
    {
        ...
        acoust->ropePoints = arena_allocate_array(gMemoryArena, v2, acoust->ropePointCount, default_memory_alloc());
        acoust->prevRopePoints = arena_allocate_array(gMemoryArena, v2, acoust->ropePointCount, default_memory_alloc());
