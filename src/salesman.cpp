...
DRAW_IMAGE(draw_image)
{
    ...
    if (!state->initialized)
    {
        ...
        salesmanState->currentPath = arena_allocate_array(gMemoryArena, u32, salesmanState->cityCount, default_memory_alloc());
        salesmanState->bestEver = arena_allocate_array(gMemoryArena, u32, salesmanState->cityCount, default_memory_alloc());
