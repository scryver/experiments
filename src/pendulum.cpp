...
DRAW_IMAGE(draw_image)
{
    ...
    draw_line(image, round32(pendulum->origin.x), round32(pendulum->origin.y),
              round32(pendulum->bob.x), round32(pendulum->bob.y), V4(1, 1, 1, 1));
    fill_circle(image, round32(pendulum->bob.x), round32(pendulum->bob.y), 16, V4(1, 1, 1, 1));
